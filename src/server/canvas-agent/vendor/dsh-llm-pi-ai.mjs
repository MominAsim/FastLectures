// Generated by scripts/build-harness-backports.cjs. MIT, Copyright (c) 2026 DeepSeek.
...
*/
async function* toStreamChunks(events, contextWindow, requestedModel) {
	...
	async *streamWithSnapshot(options, snapshot) {
		...
		try {
			...
			try {
				...
				}), model.contextWindow, model.id)[Symbol.asyncIterator]();
				let exhausted = false;
				try {
					while (true) {
