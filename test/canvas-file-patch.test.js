...
test('strict patch rejects conflicts, wrong path, invalid counts and oversized output in both runtimes',()=>{for(const api of [nodeApi,browserApi]){
 ...
 assert.throws(()=>api.validateCanvasFilePatch('--- a/context.md\n+++ b/context.md\n@@ -1,2 +1,1 @@\n-old\n+new\n','context.md'),{code:'invalid_patch'});
