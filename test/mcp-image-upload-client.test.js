...
function receipt(bytes,options){const hash=crypto.createHash('sha256').update(bytes).digest('hex');return {source:'fastlectures-asset:'+hash,assetId:hash,inputSha256:hash,name:'canonical.webp',mediaType:'image/webp',bytes:12,width:1,height:2,revision:1,canvasId:options.canvasId,documentId:options.documentId,requestId:options.requestId};}
