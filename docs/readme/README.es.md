...
<p align="center">
  <a href="https://fastlectures.ai">Sitio web</a> ·
  <a href="https://github.com/fastlectures/fastlectures/releases/latest">Descargar</a> ·
...
<p align="center">
  <img src="https://github.com/fastlectures/fastlectures/releases/download/v0.1.0/fastlectures_full_demo.webp" alt="Demostración completa de FastLectures" width="49%">
  <img src="https://github.com/fastlectures/fastlectures/releases/download/v0.1.0/fastlectures_plugins.webp" alt="Demostración de diagramas profesionales de FastLectures" width="49%">
</p>

<p align="center">
  <img src="https://github.com/fastlectures/fastlectures/releases/download/v0.1.0/fastlectures_plugins_sub_x10.webp" alt="Demostración de extensiones de FastLectures" width="49%">
  <img src="https://github.com/fastlectures/fastlectures/releases/download/v0.1.0/play_patris.webp" alt="Demostración del lienzo interactivo de FastLectures" width="49%">
</p>
...
Sigue conversando con **Codex, Claude, Kimi u otros agentes de IA**. Deja que FastLectures le dé un lugar a tu trabajo.
...
| --- | --- | --- |
| Trabaja con el agente de IA que ya utilizas. | El servidor MCP de FastLectures lleva diagramas, documentos y vistas previas interactivas al Canvas. | Prueba el resultado, anótalo y deja que tu agente lea tus comentarios para la siguiente revisión. |

<p align="center">
<<<<<<< HEAD
  <a href="../assets/mcp-spatial-example.png">
    <img src="../assets/mcp-spatial-example.png" alt="Una conversación de arquitectura con IA, con comentarios manuscritos junto al diseño propuesto en un Canvas de FastLectures" width="760">
=======
...
| **Cloud MCP** | Conecta agentes de IA externos directamente a tus Canvas de FastLectures Cloud habilitados para leer contenido, crear y editar resultados y seguir tus comentarios manuscritos. Cloud MCP y Local MCP son vías de conexión opcionales. |
| **API FastLectures Cloud Credits** | Usa modelos alojados por FastLectures con créditos de tu cuenta, junto con tus propias conexiones API y CLI. Consulta los modelos disponibles, las tarifas y el saldo en Ajustes. |
...
<p align="center">
  <img src="../../public/fastlectures-architecture.webp" alt="Arquitectura de FastLectures: un navegador se conecta a FastLectures Cloud o a tu PC local. Cloud incluye modelos alojados y se conecta a tu dispositivo vinculado. Tu PC ejecuta FastLectures CLI o App con tu API de modelos o tus agentes. Los agentes de IA externos pueden usar Cloud MCP o Local MCP; ambas conexiones son opcionales." width="1483">
</p>

Abre FastLectures en un navegador a través de FastLectures Cloud o de tu PC local con la CLI o la aplicación de escritorio en ejecución. Cloud ofrece modelos alojados y puede conectarse a tu dispositivo vinculado; tu PC puede usar tu propia API de modelos o tus agentes. Los agentes de IA externos, como Codex y Claude, pueden conectarse mediante Cloud MCP o Local MCP. Ambas conexiones MCP son opcionales.

Consulta las [notas de arquitectura](../architecture.md) para conocer los detalles de implementación.

## Inicio rápido

**Escritorio:** descarga la aplicación para Windows o macOS desde [GitHub Releases](https://github.com/fastlectures/fastlectures/releases/latest).
...
Abre `http://localhost:3888`. Añade tu propia API de modelos o una CLI de Codex, Claude Code o Kimi autenticada en **Ajustes → Conexiones**. Las conexiones se guardan en `~/.fastlectures/connections.json`; los ajustes generales permanecen en `~/.fastlectures/config.env`. Para los modelos alojados por FastLectures, inicia sesión y selecciona un modelo disponible en Ajustes.
...
1. Inicia FastLectures y habilita el Canvas actual en **Ajustes → Servicio MCP**.
...
3. Pide a tu agente: **«Muestra la arquitectura que comentamos en mi Canvas de FastLectures».**

El agente puede capturar contenido relevante, editar objetos, crear resultados visuales, modificar archivos fuente de documentos y recibir tus comentarios. Solo se pueden descubrir los Canvas habilitados y conectados. Con Local MCP, el cliente MCP se ejecuta en el host de FastLectures; la compatibilidad con navegadores de red local y de dispositivos vinculados no expone públicamente el punto de acceso MCP local. Cloud MCP es una conexión HTTPS autenticada independiente para tus Canvas habilitados de FastLectures Cloud.

Las instalaciones de escritorio deben usar la configuración generada, que incluye el entorno de ejecución integrado correcto. Consulta la [configuración de MCP](../mcp-setup.md) y la [habilidad de flujo de trabajo para agentes](../../skills/fastlectures-mcp/SKILL.md), opcional.

## FastLectures Cloud y conexiones de IA

[FastLectures Cloud](https://fastlectures.ai) añade proyectos privados con historial de versiones, favoritos sincronizados, publicación mediante Echoes y acceso remoto a un ordenador vinculado.

| Conexión | Cómo funciona |
| --- | --- |
| **Modelos de FastLectures** | Inicia sesión, selecciona un modelo alojado disponible y usa los créditos de tu cuenta. Ajustes muestra las tarifas y el saldo actuales. |
...
Tus propias conexiones API y CLI no consumen créditos de FastLectures. La cuenta de Cloud es opcional para el uso local con tu propia conexión. Las funciones de IA requieren acceso al proveedor seleccionado; ejecutar FastLectures localmente no permite usar sin conexión un modelo remoto.

## Configuraciones de modelos recomendadas

Estas recomendaciones equilibran la calidad de respuesta y la latencia de las tareas reales del lienzo de FastLectures, según pruebas prácticas actuales; el tiempo de respuesta real varía según el proveedor, la complejidad del lienzo y el comportamiento de razonamiento.
...
| [Kimi K3](https://platform.kimi.ai?aff=fastlectures) (`kimi-k3`) | `medium` | Muy buena calidad; `medium` mantiene un equilibrio práctico | Configuración predeterminada recomendada para Kimi |
...
Lee [CONTRIBUTING.md](../../CONTRIBUTING.md) para contribuir; ejecuta `npm run check` antes de abrir una pull request. Informa de errores en [Issues](https://github.com/fastlectures/fastlectures/issues), comenta ideas en [Discussions](https://github.com/fastlectures/fastlectures/discussions) o únete a [Discord](https://discord.gg/3jrPJ3mXdX).
